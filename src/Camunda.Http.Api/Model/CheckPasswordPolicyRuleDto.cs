...
namespace Camunda.Http.Api.Model
{
    ...
    public partial class CheckPasswordPolicyRuleDto : IEquatable<CheckPasswordPolicyRuleDto>, IValidatableObject
    {
        /// <summary>
        ...
        public CheckPasswordPolicyRuleDto(bool? valid = default(bool?), string placeholder = default(string), Dictionary<string, string> _parameter = default(Dictionary<string, string>))
        {
            this.Valid = valid;
        ...
        {
            return this.Equals(input as CheckPasswordPolicyRuleDto);
        }

        /// <summary>
        /// Returns true if CheckPasswordPolicyRuleDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CheckPasswordPolicyRuleDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CheckPasswordPolicyRuleDto input)
        {
            if (input == null)
                return false;
