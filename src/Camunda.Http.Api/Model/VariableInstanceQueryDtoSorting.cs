...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VariableInstanceQueryDto_sorting")]
    public partial class VariableInstanceQueryDtoSorting : IEquatable<VariableInstanceQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VariableInstanceQueryDtoSorting" /> class.
        /// </summary>
        ...
        public VariableInstanceQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as VariableInstanceQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if VariableInstanceQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of VariableInstanceQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VariableInstanceQueryDtoSorting input)
        {
            if (input == null)
                return false;
