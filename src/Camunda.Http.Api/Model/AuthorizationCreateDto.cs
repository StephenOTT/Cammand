...
namespace Camunda.Http.Api.Model
{
    ...
    public partial class AuthorizationCreateDto : IEquatable<AuthorizationCreateDto>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AuthorizationCreateDto);
        }

        /// <summary>
        /// Returns true if AuthorizationCreateDto instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthorizationCreateDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthorizationCreateDto input)
        {
            if (input == null)
                return false;
