...
namespace Camunda.Http.Api.Model
{
    ...
    public partial class LockExternalTaskDto : IEquatable<LockExternalTaskDto>, IValidatableObject
    {
        /// <summary>
        ...
        public LockExternalTaskDto(long lockDuration = default(long), string workerId = default(string))
        {
        ...
        {
            return this.Equals(input as LockExternalTaskDto);
        }

        /// <summary>
        /// Returns true if LockExternalTaskDto instances are equal
        /// </summary>
        /// <param name="input">Instance of LockExternalTaskDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LockExternalTaskDto input)
        {
            if (input == null)
                return false;
