...
namespace Camunda.Http.Api.Model
{
    ...
    /// CommentDtoAllOf
    /// </summary>
    [DataContract(Name = "CommentDto_allOf")]
    public partial class CommentDtoAllOf : IEquatable<CommentDtoAllOf>, IValidatableObject
    {
        ...
        public CommentDtoAllOf(string id = default(string), string userId = default(string), string taskId = default(string), DateTimeOffset? time = default(DateTimeOffset?), string message = default(string), DateTimeOffset? removalTime = default(DateTimeOffset?), string rootProcessInstanceId = default(string))
        {
            this.Id = id;
            this.UserId = userId;
            this.TaskId = taskId;
