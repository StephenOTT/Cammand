...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ExecutionQueryDto_sorting")]
    public partial class ExecutionQueryDtoSorting : IEquatable<ExecutionQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExecutionQueryDtoSorting" /> class.
        /// </summary>
        ...
        public ExecutionQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as ExecutionQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if ExecutionQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of ExecutionQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExecutionQueryDtoSorting input)
        {
            if (input == null)
                return false;
