...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupQueryDto_sorting")]
    public partial class GroupQueryDtoSorting : IEquatable<GroupQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupQueryDtoSorting" /> class.
        /// </summary>
        ...
        public GroupQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as GroupQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if GroupQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupQueryDtoSorting input)
        {
            if (input == null)
                return false;
