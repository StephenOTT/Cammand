...
namespace Camunda.Http.Api.Model
{
    ...
    /// JobQueryDtoSorting
    /// </summary>
    [DataContract(Name = "JobQueryDto_sorting")]
    public partial class JobQueryDtoSorting : IEquatable<JobQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JobQueryDtoSorting" /> class.
        /// </summary>
        ...
        public JobQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as JobQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if JobQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of JobQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobQueryDtoSorting input)
        {
            if (input == null)
                return false;
