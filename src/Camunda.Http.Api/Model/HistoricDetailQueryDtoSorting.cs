...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricDetailQueryDto_sorting")]
    public partial class HistoricDetailQueryDtoSorting : IEquatable<HistoricDetailQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        public enum SortByEnum
        {
            ...
            /// <summary>
            /// Enum VariableName for value: variableName
            /// </summary>
            [EnumMember(Value = "variableName")]
            VariableName = 2,

            /// <summary>
            /// Enum VariableType for value: variableType
            /// </summary>
            [EnumMember(Value = "variableType")]
            VariableType = 3,

            /// <summary>
            /// Enum VariableRevision for value: variableRevision
            /// </summary>
            [EnumMember(Value = "variableRevision")]
            VariableRevision = 4,

            /// <summary>
            /// Enum FormPropertyId for value: formPropertyId
            /// </summary>
            [EnumMember(Value = "formPropertyId")]
            FormPropertyId = 5,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricDetailQueryDtoSorting" /> class.
        /// </summary>
        ...
        public HistoricDetailQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as HistoricDetailQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if HistoricDetailQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricDetailQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricDetailQueryDtoSorting input)
        {
            if (input == null)
                return false;
