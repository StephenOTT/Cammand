...
namespace Camunda.Http.Api.Model
{
    ...
    /// DeploymentDtoAllOf
    /// </summary>
    [DataContract(Name = "DeploymentDto_allOf")]
    public partial class DeploymentDtoAllOf : IEquatable<DeploymentDtoAllOf>, IValidatableObject
    {
        ...
        public DeploymentDtoAllOf(string id = default(string), string tenantId = default(string), DateTimeOffset? deploymentTime = default(DateTimeOffset?), string source = default(string), string name = default(string))
        {
            this.Id = id;
