...
namespace Camunda.Http.Api.Model
{
    ...
    public partial class AttachmentDto : IEquatable<AttachmentDto>, IValidatableObject
    {
        ...
        public AttachmentDto(string id = default(string), string name = default(string), string description = default(string), string taskId = default(string), string type = default(string), string url = default(string), DateTimeOffset? createTime = default(DateTimeOffset?), DateTimeOffset? removalTime = default(DateTimeOffset?), string rootProcessInstanceId = default(string), List<AtomLink> links = default(List<AtomLink>))
        {
            this.Id = id;
            this.Name = name;
