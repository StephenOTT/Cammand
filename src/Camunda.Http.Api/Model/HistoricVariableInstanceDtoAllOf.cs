...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricVariableInstanceDto_allOf")]
    public partial class HistoricVariableInstanceDtoAllOf : IEquatable<HistoricVariableInstanceDtoAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricVariableInstanceDtoAllOf" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as HistoricVariableInstanceDtoAllOf);
        }

        /// <summary>
        /// Returns true if HistoricVariableInstanceDtoAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricVariableInstanceDtoAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricVariableInstanceDtoAllOf input)
        {
            if (input == null)
                return false;
