...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricVariableInstanceQueryDto_sorting")]
    public partial class HistoricVariableInstanceQueryDtoSorting : IEquatable<HistoricVariableInstanceQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricVariableInstanceQueryDtoSorting" /> class.
        /// </summary>
        ...
        public HistoricVariableInstanceQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as HistoricVariableInstanceQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if HistoricVariableInstanceQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricVariableInstanceQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricVariableInstanceQueryDtoSorting input)
        {
            if (input == null)
                return false;
