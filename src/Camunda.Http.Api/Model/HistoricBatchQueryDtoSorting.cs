...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricBatchQueryDto_sorting")]
    public partial class HistoricBatchQueryDtoSorting : IEquatable<HistoricBatchQueryDtoSorting>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum BatchId for value: batchId
            /// </summary>
            [EnumMember(Value = "batchId")]
            BatchId = 1,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricBatchQueryDtoSorting" /> class.
        /// </summary>
        ...
        public HistoricBatchQueryDtoSorting(SortByEnum? sortBy = default(SortByEnum?), SortOrderEnum? sortOrder = default(SortOrderEnum?))
        {
            this.SortBy = sortBy;
        ...
        {
            return this.Equals(input as HistoricBatchQueryDtoSorting);
        }

        /// <summary>
        /// Returns true if HistoricBatchQueryDtoSorting instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricBatchQueryDtoSorting to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricBatchQueryDtoSorting input)
        {
            if (input == null)
                return false;
