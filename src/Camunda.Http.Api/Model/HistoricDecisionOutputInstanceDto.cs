...
namespace Camunda.Http.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "HistoricDecisionOutputInstanceDto")]
    public partial class HistoricDecisionOutputInstanceDto : IEquatable<HistoricDecisionOutputInstanceDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HistoricDecisionOutputInstanceDto" /> class.
        /// </summary>
        /// <param name="id">The id of the decision output value..</param>
        /// <param name="decisionInstanceId">The id of the decision instance the output value belongs to..</param>
        /// <param name="clauseId">The id of the clause the output value belongs to..</param>
        /// <param name="clauseName">The name of the clause the output value belongs to..</param>
        /// <param name="ruleId">The id of the rule the output value belongs to..</param>
        /// <param name="ruleOrder">The order of the rule the output value belongs to..</param>
        ...
        public HistoricDecisionOutputInstanceDto(string id = default(string), string decisionInstanceId = default(string), string clauseId = default(string), string clauseName = default(string), string ruleId = default(string), int? ruleOrder = default(int?), string errorMessage = default(string), string variableName = default(string), string type = default(string), DateTimeOffset? createTime = default(DateTimeOffset?), DateTimeOffset? removalTime = default(DateTimeOffset?), string rootProcessInstanceId = default(string), Object value = default(Object), Dictionary<string, Object> valueInfo = default(Dictionary<string, Object>))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>The id of the decision output value.</value>
        ...
        /// </summary>
        /// <value>The id of the decision instance the output value belongs to.</value>
        ...
        /// </summary>
        /// <value>The id of the clause the output value belongs to.</value>
        ...
        /// </summary>
        /// <value>The name of the clause the output value belongs to.</value>
        ...
        /// </summary>
        /// <value>The id of the rule the output value belongs to.</value>
        ...
        /// </summary>
        /// <value>The order of the rule the output value belongs to.</value>
        ...
        {
            return this.Equals(input as HistoricDecisionOutputInstanceDto);
        }

        /// <summary>
        /// Returns true if HistoricDecisionOutputInstanceDto instances are equal
        /// </summary>
        /// <param name="input">Instance of HistoricDecisionOutputInstanceDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HistoricDecisionOutputInstanceDto input)
        {
            if (input == null)
                return false;
