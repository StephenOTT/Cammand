...
namespace Camunda.Http.Api.Api
{
    ...
    public partial class IncidentApi : IDisposable, IIncidentApi
    {
        ...
        /// <param name="jobDefinitionIdIn">Restricts to incidents that have one of the given comma-separated job definition ids. (optional)</param>
        /// <returns>ApiResponse of List&lt;CountResultDto&gt;</returns>
        public Camunda.Http.Api.Client.ApiResponse<CountResultDto> GetIncidentsCountWithHttpInfo(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTimeOffset? incidentTimestampBefore = default(DateTimeOffset?), DateTimeOffset? incidentTimestampAfter = default(DateTimeOffset?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string tenantIdIn = default(string), string jobDefinitionIdIn = default(string))
        {
            Camunda.Http.Api.Client.RequestOptions localVarRequestOptions = new Camunda.Http.Api.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CountResultDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.Http.Api.Client.ApiResponse<CountResultDto>> GetIncidentsCountWithHttpInfoAsync(string incidentId = default(string), string incidentType = default(string), string incidentMessage = default(string), string incidentMessageLike = default(string), string processDefinitionId = default(string), string processDefinitionKeyIn = default(string), string processInstanceId = default(string), string executionId = default(string), DateTimeOffset? incidentTimestampBefore = default(DateTimeOffset?), DateTimeOffset? incidentTimestampAfter = default(DateTimeOffset?), string activityId = default(string), string failedActivityId = default(string), string causeIncidentId = default(string), string rootCauseIncidentId = default(string), string configuration = default(string), string tenantIdIn = default(string), string jobDefinitionIdIn = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
