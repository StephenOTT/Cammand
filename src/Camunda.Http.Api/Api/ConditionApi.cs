...
namespace Camunda.Http.Api.Api
{
    ...
    public partial class ConditionApi : IDisposable, IConditionApi
    {
        ...
        /// <returns></returns>
        public ConditionApi(Camunda.Http.Api.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public ConditionApi(HttpClient client, Camunda.Http.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public ConditionApi(Camunda.Http.Api.Client.ISynchronousClient client, Camunda.Http.Api.Client.IAsynchronousClient asyncClient, Camunda.Http.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            Camunda.Http.Api.Client.ApiResponse<List<ProcessInstanceDto>> localVarResponse = EvaluateConditionWithHttpInfo(evaluationConditionDto);
        ...
        /// <param name="evaluationConditionDto"> (optional)</param>
        /// <returns>ApiResponse of List&lt;ProcessInstanceDto&gt;</returns>
        public Camunda.Http.Api.Client.ApiResponse<List<ProcessInstanceDto>> EvaluateConditionWithHttpInfo(EvaluationConditionDto evaluationConditionDto = default(EvaluationConditionDto))
        {
        ...
        {
            Camunda.Http.Api.Client.ApiResponse<List<ProcessInstanceDto>> localVarResponse = await EvaluateConditionWithHttpInfoAsync(evaluationConditionDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ProcessInstanceDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.Http.Api.Client.ApiResponse<List<ProcessInstanceDto>>> EvaluateConditionWithHttpInfoAsync(EvaluationConditionDto evaluationConditionDto = default(EvaluationConditionDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
