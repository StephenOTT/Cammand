...
namespace Camunda.Http.Api.Api
{
    ...
    public partial class EngineApi : IDisposable, IEngineApi
    {
        ...
        /// <returns></returns>
        public EngineApi(Camunda.Http.Api.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public EngineApi(HttpClient client, Camunda.Http.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public EngineApi(Camunda.Http.Api.Client.ISynchronousClient client, Camunda.Http.Api.Client.IAsynchronousClient asyncClient, Camunda.Http.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        {
            Camunda.Http.Api.Client.ApiResponse<List<ProcessEngineDto>> localVarResponse = GetProcessEngineNamesWithHttpInfo();
        ...
        /// <exception cref="Camunda.Http.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;ProcessEngineDto&gt;</returns>
        public Camunda.Http.Api.Client.ApiResponse<List<ProcessEngineDto>> GetProcessEngineNamesWithHttpInfo()
        {
        ...
        {
            Camunda.Http.Api.Client.ApiResponse<List<ProcessEngineDto>> localVarResponse = await GetProcessEngineNamesWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;ProcessEngineDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.Http.Api.Client.ApiResponse<List<ProcessEngineDto>>> GetProcessEngineNamesWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
