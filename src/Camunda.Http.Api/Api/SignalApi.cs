...
namespace Camunda.Http.Api.Api
{
    ...
    public partial class SignalApi : IDisposable, ISignalApi
    {
        ...
        /// <returns></returns>
        public SignalApi(Camunda.Http.Api.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public SignalApi(HttpClient client, Camunda.Http.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public SignalApi(Camunda.Http.Api.Client.ISynchronousClient client, Camunda.Http.Api.Client.IAsynchronousClient asyncClient, Camunda.Http.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <param name="signalDto"> (optional)</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Camunda.Http.Api.Client.ApiResponse<Object> ThrowSignalWithHttpInfo(SignalDto signalDto = default(SignalDto))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Camunda.Http.Api.Client.ApiResponse<Object>> ThrowSignalWithHttpInfoAsync(SignalDto signalDto = default(SignalDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
