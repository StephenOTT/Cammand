...
namespace Camunda.Http.Api.Api
{
    ...
    public partial class EventSubscriptionApi : IDisposable, IEventSubscriptionApi
    {
        ...
        /// <returns></returns>
        public EventSubscriptionApi(Camunda.Http.Api.Client.Configuration configuration)
        {
        ...
        /// The features affected are: Setting and Retrieving Cookies, Client Certificates, Proxy settings.
        /// </remarks>
        public EventSubscriptionApi(HttpClient client, Camunda.Http.Api.Client.Configuration configuration, HttpClientHandler handler = null)
        {
            if (configuration == null) throw new ArgumentNullException("configuration");
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <exception cref="ArgumentNullException"></exception>
        public EventSubscriptionApi(Camunda.Http.Api.Client.ISynchronousClient client, Camunda.Http.Api.Client.IAsynchronousClient asyncClient, Camunda.Http.Api.Client.IReadableConfiguration configuration)
        {
            if (client == null) throw new ArgumentNullException("client");
        ...
        /// <summary>
        /// Get List Queries for event subscriptions that fulfill given parameters. The size of the result set can be retrieved by using the [Get Event Subscriptions count](https://docs.camunda.org/manual/latest/reference/rest/event-subscription/get-query-count/) method.
        /// </summary>
        /// <exception cref="Camunda.Http.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="eventSubscriptionId">Only select subscription with the given id. (optional)</param>
        /// <param name="eventName">Only select subscriptions for events with the given name. (optional)</param>
        ...
        /// <param name="maxResults">Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)</param>
        /// <returns>ApiResponse of List&lt;EventSubscriptionDto&gt;</returns>
        public Camunda.Http.Api.Client.ApiResponse<List<EventSubscriptionDto>> GetEventSubscriptionsWithHttpInfo(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.Http.Api.Client.ClientUtils.ParameterToMultiMap("", "eventSubscriptionId", eventSubscriptionId));
            }
            if (eventName != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.Http.Api.Client.ClientUtils.ParameterToMultiMap("", "eventName", eventName));
            }
            if (eventType != null)
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.Http.Api.Client.ClientUtils.ParameterToMultiMap("", "eventType", eventType));
            }
            if (executionId != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Camunda.Http.Api.Client.ClientUtils.ParameterToMultiMap("", "includeEventSubscriptionsWithoutTenantId", includeEventSubscriptionsWithoutTenantId));
            }
            if (sortBy != null)
            {
        ...
        {
            Camunda.Http.Api.Client.ApiResponse<List<EventSubscriptionDto>> localVarResponse = await GetEventSubscriptionsWithHttpInfoAsync(eventSubscriptionId, eventName, eventType, executionId, processInstanceId, activityId, tenantIdIn, withoutTenantId, includeEventSubscriptionsWithoutTenantId, sortBy, sortOrder, firstResult, maxResults, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;EventSubscriptionDto&gt;)</returns>
        public async System.Threading.Tasks.Task<Camunda.Http.Api.Client.ApiResponse<List<EventSubscriptionDto>>> GetEventSubscriptionsWithHttpInfoAsync(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), string sortBy = default(string), string sortOrder = default(string), int? firstResult = default(int?), int? maxResults = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <summary>
        /// Get List Count Queries for the number of event subscriptions that fulfill given parameters. Takes the same parameters as the [Get Event Subscriptions](https://docs.camunda.org/manual/latest/reference/rest/event-subscription/get-query/) method.
        /// </summary>
        /// <exception cref="Camunda.Http.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="eventSubscriptionId">Only select subscription with the given id. (optional)</param>
        /// <param name="eventName">Only select subscriptions for events with the given name. (optional)</param>
        ...
        {
            Camunda.Http.Api.Client.ApiResponse<CountResultDto> localVarResponse = GetEventSubscriptionsCountWithHttpInfo(eventSubscriptionId, eventName, eventType, executionId, processInstanceId, activityId, tenantIdIn, withoutTenantId, includeEventSubscriptionsWithoutTenantId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="includeEventSubscriptionsWithoutTenantId">Select event subscriptions which have no tenant id. Can be used in combination with tenantIdIn parameter. Value may only be &#x60;true&#x60;, as &#x60;false&#x60; is the default behavior. (optional)</param>
        /// <returns>ApiResponse of CountResultDto</returns>
        public Camunda.Http.Api.Client.ApiResponse<CountResultDto> GetEventSubscriptionsCountWithHttpInfo(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?))
        {
            Camunda.Http.Api.Client.RequestOptions localVarRequestOptions = new Camunda.Http.Api.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CountResultDto)</returns>
        public async System.Threading.Tasks.Task<Camunda.Http.Api.Client.ApiResponse<CountResultDto>> GetEventSubscriptionsCountWithHttpInfoAsync(string eventSubscriptionId = default(string), string eventName = default(string), string eventType = default(string), string executionId = default(string), string processInstanceId = default(string), string activityId = default(string), string tenantIdIn = default(string), bool? withoutTenantId = default(bool?), bool? includeEventSubscriptionsWithoutTenantId = default(bool?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
