...
namespace Camunda.Http.Api.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
                    ...
                    new Dictionary<string, object> {
                        ...
                        {"description", "The API server for the default process engine"},
                        {
                            "variables", new Dictionary<string, object> {
                                ...
                                {
                                    "contextPath", new Dictionary<string, object> {
                                        {"description", "No description provided"},
                    ...
                    new Dictionary<string, object> {
                        ...
                        {"description", "The API server for a named process engine"},
                        {
                            "variables", new Dictionary<string, object> {
                                ...
                                {
                                    "engineName", new Dictionary<string, object> {
                                        {"description", "No description provided"},
        ...
        {
            String report = "C# SDK (Camunda.Http.Api) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 7.16.0-alpha1\n";
